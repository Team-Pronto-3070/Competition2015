...
public interface Pronstants {
	...
	public static final int M_FLEX_ID = 6;
	...
	public static final int A_BUTTON = 1; // Lift up
	public static final int B_BUTTON = 2; // Lift down
	public static final int X_BUTTON = 3; // Flex in
	public static final int Y_BUTTON = 4; // Flex out
	public static final int LEFT_BUMPER = 5; // Load in
	public static final int RIGHT_BUMPER = 6; // Load out

	// Miscellaneous
	public static final double DEADZONE = 0.2;
	public static final double LIFT_SPEED = 1.0;
	public static final double LOAD_SPEED = 1.0;
	public static final double FLEX_SPEED = .75;
